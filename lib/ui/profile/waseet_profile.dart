...
class WaseetProfile extends StatefulWidget {
  final Map<String,dynamic> data;
  const WaseetProfile({super.key, required this.data});

  @override
  State<WaseetProfile> createState() => _WaseetProfileState();
}

class _WaseetProfileState extends State<WaseetProfile> {
  ...
  void initState() {
    setState(() {
      ...
      licenseNumber.text=widget.data['licenseNumber'];
